...
<div class="main-header">
    ...
    <p>Tác giả: Nguyễn Thị Mai - Trường tiểu học 1-5 - ĐT: 0978647896</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Nguyễn Thị Mai - Trường Tiểu học 1-5 - ĐT: 0978 64 7896</div>", unsafe_allow_html=True)
